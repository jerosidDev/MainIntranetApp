...
function SendAjaxPost(button: any) {
    ...
    let tbaLoc: TBALocation = { CODE: label.attr('value'), NAME: label.text(), Csl_Assigned_INITIAL: selectOption.val() };
    let cc: ContractConsultant = { INITIALS: selectOption.val(), NAME: selectOption.text(), LocationsAssigned: [tbaLoc] };
